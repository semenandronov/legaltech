...
1. СНАЧАЛА: Проанализируй все извлеченные сущности (PERSON, ORG) для понимания участников дела
2. ЗАТЕМ: Для каждой пары сущностей определи тип связи на основе контекста документов
3. ДАЛЕЕ: Определи направление связи (кто с кем связан и как)
4. ПОТОМ: Проверь полноту графа связей (все ли важные связи найдены)
5. НАКОНЕЦ: Сформируй структурированный JSON с nodes и edges для визуализации графа
